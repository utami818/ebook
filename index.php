    ...
    if(mysqli_num_rows($cek_user)){
        while($row = mysqli_fetch_assoc($cek_user)){
            ...
            if($password == $pass_db){
                ...
                $cek_pass = '<p class="form-error">Password yang anada masukkkan salah!</p>';
            }
        }
    }else{
        $cek_email = '<p class="form-error">Email belum terdaftar</p>';
    }
}
...
<head>
    ...
    <!-- end atas Bootstrap CSS -->
    <link rel="stylesheet" href="css/home.css">
    <title>E-book Airlangga</title>
</head>
<body id="page-top">
    ...
    <div class="container">  
        <div class="modal fade" id="exampleModalcontact">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <p>Q-DIV team MBI</p>
                            <ul>
                            <li>085602703797 <i class="fab fa-whatsapp"></i></li>
                            </ul>
                        <p>Academic team MBI</p>
                            <ul>
                            <li>085608625588 <i class="fab fa-whatsapp"></i></li>
                            </ul>
                            <form action="index.php" method="POST">
                            <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
                            </form>
    ...
    <footer>
        <div class="footer fixed-bottom text-center">
            <div class="container">
                <div></div>
                <p>Build <i class="fas fa-code"></i> with Q-div <a href="#" data-toggle="modal" data-target="#exampleModalcontact">contact us <i class="fab fa-whatsapp"></i></a> copyRight&copy;MbiConsultant2020</p>
            </div>
        </div>
    </footer>
