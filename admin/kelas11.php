<?php require_once('../asset/head.php');?>
    <title>E-book Airlangga Kelas 11</title>
</head>
<body id="page-top">
    ...
    <header class="masthead" id="umum">
        <div class="container">
          <div class="intro-text">   
            <div class="intro-lead-in"> E-book Kelas 11 </div>
            <div class="intro-heading">Umum</div>
                <div class="row" id="card">
                    <div class="card " style="width: 18rem;">
                        <div class="card-body">
                        <h5 class="card-title">IPS</h5>
                        <h6 class="card-subtitle mb-2">IPS XII</h6>
                        <p class="card-text"><img src="../images/coverreg11s.jpeg" alt=""></p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                  <h2 class="section-heading text-uppercase">E-Book Terapan</h2>
            ...
            <div class="row">
                <div class="row" id="card">
                    <div class="card" style="width: 18rem;">
                        ...
                        <p class="card-text"><img src="../images/coverreg11a.jpeg" alt=""></p>
                        <a href="#" class="card-link">Baca</a>
                        </div>
                    </div>
                    <div class="card" style="width: 18rem;">
